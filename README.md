...
![Light theme popup](assets/screenshots/light-theme-popup.png)

**Dark Theme Popup:** Extension interface in dark mode.

![Dark theme popup](assets/screenshots/dark-theme-popup.png)

**Full Block Mode:** All distractions removed for maximum focus.

![Block all distractions](assets/screenshots/block-all.png)

**Show Top Bar Only:** Minimal UI with top navigation visible.

![Show top bar](assets/screenshots/show-top-bar.png)
